# Mori Mochi — Project Snapshot (for resume)

Title: Mori Mochi — Aesthetic UI Demo

- Built a responsive single-page demo for a matcha & coffee bakery showcasing clean, modern UI design.
- Implemented with semantic HTML5, CSS Grid/Flexbox and custom properties, and vanilla JavaScript for interactive filters and accessible smooth scroll.
